...
namespace Mu
{
    ...
    void QDirType::registerFinalizer(void* o) { GC_register_finalizer(o, QDirType::finalizer, 0, 0, 0); }
    ...
    Pointer qt_QDir_QDir_QDir_QDir_string_string_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_path,
    ...
    Pointer qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_stringBSB_ESB__int_int(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                                    Pointer param_nameFilters, int param_filters,
                                                                                    int param_sort)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QDir& arg0 = getqtype<QDirType>(param_this);
    ...
    Pointer qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_filters,
                                                                     int param_sort)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QDir& arg0 = getqtype<QDirType>(param_this);
    ...
    Pointer qt_QDir_entryList_stringBSB_ESB__QDir_stringBSB_ESB__int_int(Mu::Thread& NODE_THREAD, Pointer param_this,
                                                                         Pointer param_nameFilters, int param_filters, int param_sort)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QDir& arg0 = getqtype<QDirType>(param_this);
        const QStringList arg1 = qstringlist(param_nameFilters);
    ...
    bool qt_QDir_isEmpty_bool_QDir_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_filters)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QDir& arg0 = getqtype<QDirType>(param_this);
        QDir::Filters arg1 = (QDir::Filters)(param_filters);
        return arg0.isEmpty(arg1);
    }
    ...
    bool qt_QDir_mkdir_bool_QDir_string_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_dirName, int param_permissions)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QDir& arg0 = getqtype<QDirType>(param_this);
        const QString arg1 = qstring(param_dirName);
        QFile::Permissions arg2 = (QFile::Permissions)(param_permissions);
        return arg0.mkdir(arg1, arg2);
    }
    ...
    static NODE_IMPLEMENTATION(_n_QDir0, Pointer)
    {
    ...
    {
        NODE_RETURN(qt_QDir_QDir_QDir_QDir_string_string_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
    ...
    static NODE_IMPLEMENTATION(_n_cdUp0, bool) { NODE_RETURN(qt_QDir_cdUp_bool_QDir(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_stringBSB_ESB__int_int(
            NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int), NODE_ARG(3, int)));
    }

    static NODE_IMPLEMENTATION(_n_entryInfoList1, Pointer)
    {
        NODE_RETURN(qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
                                                                             NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_entryList0, Pointer)
    {
        NODE_RETURN(qt_QDir_entryList_stringBSB_ESB__QDir_stringBSB_ESB__int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
    ...
    {
        NODE_RETURN(
            qt_QDir_entryList_stringBSB_ESB__QDir_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_exists1, bool) { NODE_RETURN(qt_QDir_exists_bool_QDir(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_filter0, int) { NODE_RETURN(qt_QDir_filter_int_QDir(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    {
        NODE_RETURN(qt_QDir_isEmpty_bool_QDir_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
    }
    ...
    {
        NODE_RETURN(qt_QDir_mkdir_bool_QDir_string_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_mkdir1, bool)
    {
    ...
    {
        NODE_RETURN(
            qt_QDir_rename_bool_QDir_string_string(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_sorting0, int) { NODE_RETURN(qt_QDir_sorting_int_QDir(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer))); }
    ...
    static NODE_IMPLEMENTATION(_n_cleanPath0, Pointer) { NODE_RETURN(qt_QDir_cleanPath_string_string(NODE_THREAD, NODE_ARG(0, Pointer))); }

    static NODE_IMPLEMENTATION(_n_current0, Pointer) { NODE_RETURN(qt_QDir_current_QDir(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_currentPath0, Pointer) { NODE_RETURN(qt_QDir_currentPath_string(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_drives0, Pointer) { NODE_RETURN(qt_QDir_drives_qt__QFileInfoBSB_ESB_(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_home0, Pointer) { NODE_RETURN(qt_QDir_home_QDir(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_homePath0, Pointer) { NODE_RETURN(qt_QDir_homePath_string(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_root0, Pointer) { NODE_RETURN(qt_QDir_root_QDir(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_rootPath0, Pointer) { NODE_RETURN(qt_QDir_rootPath_string(NODE_THREAD)); }
    ...
    static NODE_IMPLEMENTATION(_n_temp0, Pointer) { NODE_RETURN(qt_QDir_temp_QDir(NODE_THREAD)); }

    static NODE_IMPLEMENTATION(_n_tempPath0, Pointer) { NODE_RETURN(qt_QDir_tempPath_string(NODE_THREAD)); }
    ...
    void QDirType::load()
    {
        ...
        addSymbols(
            new Alias(c, "Filter", "int"), new Alias(c, "Filters", "int"), new SymbolicConstant(c, "Dirs", "int", Value(int(QDir::Dirs))),
            ...
            new SymbolicConstant(c, "CaseSensitive", "int", Value(int(QDir::CaseSensitive))), new Alias(c, "SortFlag", "int"),
            new Alias(c, "SortFlags", "int"), new SymbolicConstant(c, "Name", "int", Value(int(QDir::Name))),
            new SymbolicConstant(c, "Time", "int", Value(int(QDir::Time))), new SymbolicConstant(c, "Size", "int", Value(int(QDir::Size))),
            ...
            new SymbolicConstant(c, "LocaleAware", "int", Value(int(QDir::LocaleAware))), EndArguments);

        addSymbols(
            // enums
            // member functions
            new Function(c, "QDir", _n_QDir0, None, Compiled, qt_QDir_QDir_QDir_QDir_string, Return, "qt.QDir", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "path", "string"), End),
            new Function(c, "QDir", _n_QDir1, None, Compiled, qt_QDir_QDir_QDir_QDir_string_string_int_int, Return, "qt.QDir", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "path", "string"), new Param(c, "nameFilter", "string"),
                         new Param(c, "sort", "int", Value((int)QDir::SortFlags(QDir::Name | QDir::IgnoreCase))),
                         new Param(c, "filters", "int", Value((int)QDir::AllEntries)), End),
            // MISSING: QDir (QDir; QDir this, QDir dir)
            new Function(c, "absoluteFilePath", _n_absoluteFilePath0, None, Compiled, qt_QDir_absoluteFilePath_string_QDir_string, Return,
                         "string", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "fileName", "string"), End),
            new Function(c, "absolutePath", _n_absolutePath0, None, Compiled, qt_QDir_absolutePath_string_QDir, Return, "string",
                         Parameters, new Param(c, "this", "qt.QDir"), End),
            new Function(c, "canonicalPath", _n_canonicalPath0, None, Compiled, qt_QDir_canonicalPath_string_QDir, Return, "string",
                         Parameters, new Param(c, "this", "qt.QDir"), End),
            new Function(c, "cd", _n_cd0, None, Compiled, qt_QDir_cd_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), End),
            new Function(c, "cdUp", _n_cdUp0, None, Compiled, qt_QDir_cdUp_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            // MISSING: count ("qsizetype"; QDir this)
            new Function(c, "dirName", _n_dirName0, None, Compiled, qt_QDir_dirName_string_QDir, Return, "string", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "entryInfoList", _n_entryInfoList0, None, Compiled,
                         qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_stringBSB_ESB__int_int, Return, "qt.QFileInfo[]", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "nameFilters", "string[]"), new Param(c, "filters", "int"),
                         new Param(c, "sort", "int"), End),
            new Function(c, "entryInfoList", _n_entryInfoList1, None, Compiled, qt_QDir_entryInfoList_qt__QFileInfoBSB_ESB__QDir_int_int,
                         Return, "qt.QFileInfo[]", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "filters", "int"),
                         new Param(c, "sort", "int"), End),
            new Function(c, "entryList", _n_entryList0, None, Compiled, qt_QDir_entryList_stringBSB_ESB__QDir_stringBSB_ESB__int_int,
                         Return, "string[]", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "nameFilters", "string[]"),
                         new Param(c, "filters", "int"), new Param(c, "sort", "int"), End),
            new Function(c, "entryList", _n_entryList1, None, Compiled, qt_QDir_entryList_stringBSB_ESB__QDir_int_int, Return, "string[]",
                         Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "filters", "int"), new Param(c, "sort", "int"), End),
            new Function(c, "exists", _n_exists0, None, Compiled, qt_QDir_exists_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "name", "string"), End),
            new Function(c, "exists", _n_exists1, None, Compiled, qt_QDir_exists_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "filePath", _n_filePath0, None, Compiled, qt_QDir_filePath_string_QDir_string, Return, "string", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "fileName", "string"), End),
            new Function(c, "filter", _n_filter0, None, Compiled, qt_QDir_filter_int_QDir, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "isAbsolute", _n_isAbsolute0, None, Compiled, qt_QDir_isAbsolute_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QDir_isEmpty_bool_QDir_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"),
                         new Param(c, "filters", "int", Value((int)QDir::Filters(QDir::AllEntries | QDir::NoDotAndDotDot))), End),
            new Function(c, "isReadable", _n_isReadable0, None, Compiled, qt_QDir_isReadable_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "isRelative", _n_isRelative0, None, Compiled, qt_QDir_isRelative_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "isRoot", _n_isRoot0, None, Compiled, qt_QDir_isRoot_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "makeAbsolute", _n_makeAbsolute0, None, Compiled, qt_QDir_makeAbsolute_bool_QDir, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "mkdir", _n_mkdir0, None, Compiled, qt_QDir_mkdir_bool_QDir_string_int, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), new Param(c, "permissions", "int"), End),
            new Function(c, "mkdir", _n_mkdir1, None, Compiled, qt_QDir_mkdir_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), End),
            new Function(c, "mkpath", _n_mkpath0, None, Compiled, qt_QDir_mkpath_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirPath", "string"), End),
            new Function(c, "nameFilters", _n_nameFilters0, None, Compiled, qt_QDir_nameFilters_stringBSB_ESB__QDir, Return, "string[]",
                         Parameters, new Param(c, "this", "qt.QDir"), End),
            new Function(c, "path", _n_path0, None, Compiled, qt_QDir_path_string_QDir, Return, "string", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "refresh", _n_refresh0, None, Compiled, qt_QDir_refresh_void_QDir, Return, "void", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "relativeFilePath", _n_relativeFilePath0, None, Compiled, qt_QDir_relativeFilePath_string_QDir_string, Return,
                         "string", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "fileName", "string"), End),
            new Function(c, "remove", _n_remove0, None, Compiled, qt_QDir_remove_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "fileName", "string"), End),
            new Function(c, "removeRecursively", _n_removeRecursively0, None, Compiled, qt_QDir_removeRecursively_bool_QDir, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QDir"), End),
            new Function(c, "rename", _n_rename0, None, Compiled, qt_QDir_rename_bool_QDir_string_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "oldName", "string"), new Param(c, "newName", "string"), End),
            new Function(c, "rmdir", _n_rmdir0, None, Compiled, qt_QDir_rmdir_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirName", "string"), End),
            new Function(c, "rmpath", _n_rmpath0, None, Compiled, qt_QDir_rmpath_bool_QDir_string, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "dirPath", "string"), End),
            new Function(c, "setFilter", _n_setFilter0, None, Compiled, qt_QDir_setFilter_void_QDir_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "filters", "int"), End),
            new Function(c, "setNameFilters", _n_setNameFilters0, None, Compiled, qt_QDir_setNameFilters_void_QDir_stringBSB_ESB_, Return,
                         "void", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "nameFilters", "string[]"), End),
            new Function(c, "setPath", _n_setPath0, None, Compiled, qt_QDir_setPath_void_QDir_string, Return, "void", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "path", "string"), End),
            new Function(c, "setSorting", _n_setSorting0, None, Compiled, qt_QDir_setSorting_void_QDir_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "sort", "int"), End),
            new Function(c, "sorting", _n_sorting0, None, Compiled, qt_QDir_sorting_int_QDir, Return, "int", Parameters,
                         new Param(c, "this", "qt.QDir"), End),
            new Function(c, "swap", _n_swap0, None, Compiled, qt_QDir_swap_void_QDir_QDir, Return, "void", Parameters,
                         new Param(c, "this", "qt.QDir"), new Param(c, "other", "qt.QDir"), End),
            // static functions
            new Function(c, "addSearchPath", _n_addSearchPath0, None, Compiled, qt_QDir_addSearchPath_void_string_string, Return, "void",
                         Parameters, new Param(c, "prefix", "string"), new Param(c, "path", "string"), End),
            new Function(c, "cleanPath", _n_cleanPath0, None, Compiled, qt_QDir_cleanPath_string_string, Return, "string", Parameters,
            ...
            new Function(c, "fromNativeSeparators", _n_fromNativeSeparators0, None, Compiled, qt_QDir_fromNativeSeparators_string_string,
                         Return, "string", Parameters, new Param(c, "pathName", "string"), End),
            ...
            new Function(c, "isAbsolutePath", _n_isAbsolutePath0, None, Compiled, qt_QDir_isAbsolutePath_bool_string, Return, "bool",
                         Parameters, new Param(c, "path", "string"), End),
            new Function(c, "isRelativePath", _n_isRelativePath0, None, Compiled, qt_QDir_isRelativePath_bool_string, Return, "bool",
                         Parameters, new Param(c, "path", "string"), End),
            // MISSING: listSeparator ("QChar"; )
            new Function(c, "match", _n_match0, None, Compiled, qt_QDir_match_bool_string_string, Return, "bool", Parameters,
                         new Param(c, "filter", "string"), new Param(c, "fileName", "string"), End),
            new Function(c, "match", _n_match1, None, Compiled, qt_QDir_match_bool_stringBSB_ESB__string, Return, "bool", Parameters,
                         new Param(c, "filters", "string[]"), new Param(c, "fileName", "string"), End),
            ...
            new Function(c, "searchPaths", _n_searchPaths0, None, Compiled, qt_QDir_searchPaths_stringBSB_ESB__string, Return, "string[]",
                         Parameters, new Param(c, "prefix", "string"), End),
            // MISSING: separator ("QChar"; )
            new Function(c, "setCurrent", _n_setCurrent0, None, Compiled, qt_QDir_setCurrent_bool_string, Return, "bool", Parameters,
                         new Param(c, "path", "string"), End),
            new Function(c, "setSearchPaths", _n_setSearchPaths0, None, Compiled, qt_QDir_setSearchPaths_void_string_stringBSB_ESB_, Return,
                         "void", Parameters, new Param(c, "prefix", "string"), new Param(c, "searchPaths", "string[]"), End),
            ...
            new Function(c, "toNativeSeparators", _n_toNativeSeparators0, None, Compiled, qt_QDir_toNativeSeparators_string_string, Return,
                         "string", Parameters, new Param(c, "pathName", "string"), End),
            EndArguments);
        globalScope()->addSymbols(new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QDir_operatorBang_EQ__bool_QDir_QDir, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "dir", "qt.QDir"), End),
                                  // MISSING: = (QDir; QDir this, QDir dir)
                                  // MISSING: = (QDir; QDir this, "QDir & &" other)
                                  new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QDir_operatorEQ_EQ__bool_QDir_QDir, Return,
                                               "bool", Parameters, new Param(c, "this", "qt.QDir"), new Param(c, "dir", "qt.QDir"), End),
                                  // MISSING: [] (string; QDir this, "qsizetype" pos)
                                  EndArguments);
