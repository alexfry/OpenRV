...
namespace Mu
{
    ...
    void QRegionType::registerFinalizer(void* o) { GC_register_finalizer(o, QRegionType::finalizer, 0, 0, 0); }
    ...
    Pointer qt_QRegion_QRegion_QRegion_QRegion_int_int_int_int_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_x, int param_y,
    ...
    {
        NODE_RETURN(qt_QRegion_QRegion_QRegion_QRegion_int_int_int_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int),
    ...
    {
        NODE_RETURN(
            qt_QRegion_QRegion_QRegion_QRegion_QRect_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer), NODE_ARG(2, int)));
    }
    ...
    {
        NODE_RETURN(
            qt_QRegion_translated_QRegion_QRegion_int_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int), NODE_ARG(2, int)));
    }
    ...
    void QRegionType::load()
    {
        ...
        addSymbols(new Alias(c, "RegionType", "int"), new SymbolicConstant(c, "Rectangle", "int", Value(int(QRegion::Rectangle))),
                   new SymbolicConstant(c, "Ellipse", "int", Value(int(QRegion::Ellipse))), EndArguments);

        addSymbols(
            // enums
            // member functions
            new Function(c, "QRegion", _n_QRegion0, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion, Return, "qt.QRegion", Parameters,
                         new Param(c, "this", "qt.QRegion"), End),
            new Function(c, "QRegion", _n_QRegion1, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion_int_int_int_int_int, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "x", "int"), new Param(c, "y", "int"),
                         new Param(c, "w", "int"), new Param(c, "h", "int"), new Param(c, "t", "int", Value((int)QRegion::Rectangle)), End),
            new Function(c, "QRegion", _n_QRegion2, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion_QRect_int, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRect"),
                         new Param(c, "t", "int", Value((int)QRegion::Rectangle)), End),
            // MISSING: QRegion (QRegion; QRegion this, "const QPolygon &" a,
            // flags Qt::FillRule fillRule)
            new Function(c, "QRegion", _n_QRegion4, None, Compiled, qt_QRegion_QRegion_QRegion_QRegion_QBitmap, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "bm", "qt.QBitmap"), End),
            ...
            new Function(c, "boundingRect", _n_boundingRect0, None, Compiled, qt_QRegion_boundingRect_QRect_QRegion, Return, "qt.QRect",
            ...
            new Function(c, "contains", _n_contains0, None, Compiled, qt_QRegion_contains_bool_QRegion_QPoint, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QRegion"), new Param(c, "p", "qt.QPoint"), End),
            new Function(c, "contains", _n_contains1, None, Compiled, qt_QRegion_contains_bool_QRegion_QRect, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRect"), End),
            // MISSING: crbegin ("QRegion::const_reverse_iterator"; QRegion
            // this) MISSING: crend ("QRegion::const_reverse_iterator"; QRegion
            // this) MISSING: end ("QRegion::const_iterator"; QRegion this)
            new Function(c, "intersected", _n_intersected0, None, Compiled, qt_QRegion_intersected_QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "intersected", _n_intersected1, None, Compiled, qt_QRegion_intersected_QRegion_QRegion_QRect, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "rect", "qt.QRect"), End),
            new Function(c, "intersects", _n_intersects0, None, Compiled, qt_QRegion_intersects_bool_QRegion_QRegion, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "region", "qt.QRegion"), End),
            new Function(c, "intersects", _n_intersects1, None, Compiled, qt_QRegion_intersects_bool_QRegion_QRect, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "rect", "qt.QRect"), End),
            new Function(c, "isEmpty", _n_isEmpty0, None, Compiled, qt_QRegion_isEmpty_bool_QRegion, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QRegion"), End),
            new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QRegion_isNull_bool_QRegion, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QRegion"), End),
            // MISSING: rbegin ("QRegion::const_reverse_iterator"; QRegion this)
            new Function(c, "rectCount", _n_rectCount0, None, Compiled, qt_QRegion_rectCount_int_QRegion, Return, "int", Parameters,
                         new Param(c, "this", "qt.QRegion"), End),
            // MISSING: rend ("QRegion::const_reverse_iterator"; QRegion this)
            new Function(c, "subtracted", _n_subtracted0, None, Compiled, qt_QRegion_subtracted_QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "swap", _n_swap0, None, Compiled, qt_QRegion_swap_void_QRegion_QRegion, Return, "void", Parameters,
                         new Param(c, "this", "qt.QRegion"), new Param(c, "other", "qt.QRegion"), End),
            // MISSING: toHRGN ("HRGN"; QRegion this)
            new Function(c, "translate", _n_translate0, None, Compiled, qt_QRegion_translate_void_QRegion_int_int, Return, "void",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "dx", "int"), new Param(c, "dy", "int"), End),
            new Function(c, "translate", _n_translate1, None, Compiled, qt_QRegion_translate_void_QRegion_QPoint, Return, "void",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "point", "qt.QPoint"), End),
            new Function(c, "translated", _n_translated0, None, Compiled, qt_QRegion_translated_QRegion_QRegion_int_int, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "dx", "int"), new Param(c, "dy", "int"),
                         End),
            new Function(c, "translated", _n_translated1, None, Compiled, qt_QRegion_translated_QRegion_QRegion_QPoint, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "p", "qt.QPoint"), End),
            new Function(c, "united", _n_united0, None, Compiled, qt_QRegion_united_QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "united", _n_united1, None, Compiled, qt_QRegion_united_QRegion_QRegion_QRect, Return, "qt.QRegion", Parameters,
                         new Param(c, "this", "qt.QRegion"), new Param(c, "rect", "qt.QRect"), End),
            new Function(c, "xored", _n_xored0, None, Compiled, qt_QRegion_xored_QRegion_QRegion_QRegion, Return, "qt.QRegion", Parameters,
                         new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
        ...
        globalScope()->addSymbols(
            new Function(c, "!=", _n_operatorBang_EQ_0, Op, Compiled, qt_QRegion_operatorBang_EQ__bool_QRegion_QRegion, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "other", "qt.QRegion"), End),
            new Function(c, "&", _n_operatorAmp_0, Op, Compiled, qt_QRegion_operatorAmp__QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "&", _n_operatorAmp_1, Op, Compiled, qt_QRegion_operatorAmp__QRegion_QRegion_QRect, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRect"), End),
            new Function(c, "+", _n_operatorPlus_0, Op, Compiled, qt_QRegion_operatorPlus__QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "+", _n_operatorPlus_1, Op, Compiled, qt_QRegion_operatorPlus__QRegion_QRegion_QRect, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRect"), End),
            new Function(c, "+=", _n_operatorPlus_EQ_0, Op, Compiled, qt_QRegion_operatorPlus_EQ__QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "+=", _n_operatorPlus_EQ_1, Op, Compiled, qt_QRegion_operatorPlus_EQ__QRegion_QRegion_QRect, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "rect", "qt.QRect"), End),
            new Function(c, "-", _n_operatorMinus_0, Op, Compiled, qt_QRegion_operatorMinus__QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "-=", _n_operatorMinus_EQ_0, Op, Compiled, qt_QRegion_operatorMinus_EQ__QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            // MISSING: = (QRegion; QRegion this, QRegion r)
            // MISSING: = (QRegion; QRegion this, "QRegion & &" other)
            new Function(c, "==", _n_operatorEQ_EQ_0, Op, Compiled, qt_QRegion_operatorEQ_EQ__bool_QRegion_QRegion, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "^", _n_operatorCaret_0, Op, Compiled, qt_QRegion_operatorCaret__QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "^=", _n_operatorCaret_EQ_0, Op, Compiled, qt_QRegion_operatorCaret_EQ__QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "|", _n_operatorPipe_0, Op, Compiled, qt_QRegion_operatorPipe__QRegion_QRegion_QRegion, Return, "qt.QRegion",
                         Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            new Function(c, "|=", _n_operatorPipe_EQ_0, Op, Compiled, qt_QRegion_operatorPipe_EQ__QRegion_QRegion_QRegion, Return,
                         "qt.QRegion", Parameters, new Param(c, "this", "qt.QRegion"), new Param(c, "r", "qt.QRegion"), End),
            EndArguments);
