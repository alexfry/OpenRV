...
namespace Mu
{
    ...
    Pointer qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_families,
                                                                   int param_pointSize, int param_weight, bool param_italic)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QStringList arg1 = qstringlist(param_families);
        int arg2 = (int)(param_pointSize);
        int arg3 = (int)(param_weight);
        bool arg4 = (bool)(param_italic);
        setqtype<QFontType>(param_this, QFont(arg1, arg2, arg3, arg4));
    ...
    Pointer qt_QFont_QFont_QFont_QFont_QFont_QPaintDevice(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_font, Pointer param_pd)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFont arg1 = getqtype<QFontType>(param_font);
        const QPaintDevice* arg2 = paintdevice<QPaintDevice>(param_pd);
        setqtype<QFontType>(param_this, QFont(arg1, arg2));
        return param_this;
    }
    ...
    Pointer qt_QFont_families_stringBSB_ESB__QFont(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        const QFont& arg0 = getqtype<QFontType>(param_this);
        return makestringlist(c, arg0.families());
    }
    ...
    void qt_QFont_setWeight_void_QFont_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_weight)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QFont& arg0 = getqtype<QFontType>(param_this);
        QFont::Weight arg1 = (QFont::Weight)(param_weight);
        arg0.setWeight(arg1);
        setqtype<QFontType>(param_this, arg0);
    }
    ...
    static NODE_IMPLEMENTATION(_n_QFont2, Pointer)
    {
        NODE_RETURN(qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                           NODE_ARG(2, int), NODE_ARG(3, int), NODE_ARG(4, bool)));
    }

    static NODE_IMPLEMENTATION(_n_QFont3, Pointer)
    {
        NODE_RETURN(qt_QFont_QFont_QFont_QFont_QFont_QPaintDevice(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer),
                                                                  NODE_ARG(2, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_families0, Pointer)
    {
        NODE_RETURN(qt_QFont_families_stringBSB_ESB__QFont(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    static NODE_IMPLEMENTATION(_n_setFamilies0, void)
    {
        qt_QFont_setFamilies_void_QFont_stringBSB_ESB_(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, Pointer));
    }
    ...
    void QFontType::load()
    {
        ...
        addSymbols(new Alias(c, "Capitalization", "int"), new SymbolicConstant(c, "MixedCase", "int", Value(int(QFont::MixedCase))),
                   ...
                   new SymbolicConstant(c, "AnyStretch", "int", Value(int(QFont::AnyStretch))),
                   ...
                   new SymbolicConstant(c, "NoFontMerging", "int", Value(int(QFont::NoFontMerging))),
                   new SymbolicConstant(c, "PreferNoShaping", "int", Value(int(QFont::PreferNoShaping))), new Alias(c, "Weight", "int"),
        ...
        addSymbols(
            ...
            new Function(c, "QFont", _n_QFont2, None, Compiled, qt_QFont_QFont_QFont_QFont_stringBSB_ESB__int_int_bool, Return, "qt.QFont",
                         Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "families", "string[]"),
                         new Param(c, "pointSize", "int", Value((int)-1)), new Param(c, "weight", "int", Value((int)-1)),
                         new Param(c, "italic", "bool"), End),
            new Function(c, "QFont", _n_QFont3, None, Compiled, qt_QFont_QFont_QFont_QFont_QFont_QPaintDevice, Return, "qt.QFont",
                         Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "font", "qt.QFont"),
                         new Param(c, "pd", "qt.QPaintDevice"), End),
            ...
            new Function(c, "exactMatch", _n_exactMatch0, None, Compiled, qt_QFont_exactMatch_bool_QFont, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QFont"), End),
            new Function(c, "families", _n_families0, None, Compiled, qt_QFont_families_stringBSB_ESB__QFont, Return, "string[]",
                         Parameters, new Param(c, "this", "qt.QFont"), End),
            ...
            new Function(c, "setFamilies", _n_setFamilies0, None, Compiled, qt_QFont_setFamilies_void_QFont_stringBSB_ESB_, Return, "void",
                         Parameters, new Param(c, "this", "qt.QFont"), new Param(c, "families", "string[]"), End),
            ...
            new Function(c, "wordSpacing", _n_wordSpacing0, None, Compiled, qt_QFont_wordSpacing_double_QFont, Return, "double", Parameters,
                         new Param(c, "this", "qt.QFont"), End),
            // MISSING: QVariant ("QVariant operator"; QFont this)
            // static functions
