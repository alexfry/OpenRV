...
namespace Mu
{
    ...
    void qt_QImage_setAlphaChannel_void_QImage_QImage(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_alphaChannel)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QImage& arg0 = getqtype<QImageType>(param_this);
        const QImage arg1 = getqtype<QImageType>(param_alphaChannel);
    ...
    void QImageType::load()
    {
        ...
        addSymbols(
            ...
            // "uchar *" data, int width, int height, "qsizetype" bytesPerLine,
            // flags QImage::Format format, "QImageCleanupFunction"
            // cleanupFunction, "void *" cleanupInfo) MISSING: QImage (QImage;
            // QImage this, "const uchar *" data, int width, int height,
            // "qsizetype" bytesPerLine, flags QImage::Format format,
            // "QImageCleanupFunction" cleanupFunction, "void *" cleanupInfo)
            // MISSING: QImage (QImage; QImage this, "const char * const[]" xpm)
            ...
            // QColorTransform &" transform) MISSING: colorTransformed (QImage;
            ...
            // "QByteArrayView" data, "const char *" format) MISSING:
            ...
            // static functions
            // MISSING: fromData (QImage; "QByteArrayView" data, "const char *"
            // format) MISSING: fromData (QImage; "const uchar *" data, int
            // size, "const char *" format) MISSING: fromData (QImage;
            // QByteArray data, "const char *" format) MISSING: fromHBITMAP
            // (QImage; "HBITMAP" hbitmap) MISSING: fromHICON (QImage; "HICON"
