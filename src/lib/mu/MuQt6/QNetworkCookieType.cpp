...
namespace Mu
{
    ...
    void QNetworkCookieType::load()
    {
        ...
        addSymbols(new Alias(c, "RawForm", "int"),
                   ...
                   new SymbolicConstant(c, "Full", "int", Value(int(QNetworkCookie::Full))), new Alias(c, "SameSite", "int"),
                   ...
                   new SymbolicConstant(c, "Strict", "int", Value(int(QNetworkCookie::SameSite::Strict))), EndArguments);
        ...
        addSymbols(
            ...
            new Function(c, "sameSitePolicy", _n_sameSitePolicy0, None, Compiled, qt_QNetworkCookie_sameSitePolicy_int_QNetworkCookie,
                         Return, "int", Parameters, new Param(c, "this", "qt.QNetworkCookie"), End),
            ...
            new Function(c, "setSameSitePolicy", _n_setSameSitePolicy0, None, Compiled,
                         qt_QNetworkCookie_setSameSitePolicy_void_QNetworkCookie_int, Return, "void", Parameters,
                         new Param(c, "this", "qt.QNetworkCookie"), new Param(c, "sameSite", "int"), End),
