...
namespace Mu
{
    ...
    static NODE_IMPLEMENTATION(_n_QBrush8, Pointer)
    {
    ...
    void QBrushType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "QBrush", _n_QBrush8, None, Compiled, qt_QBrush_QBrush_QBrush_QBrush_QGradient, Return, "qt.QBrush", Parameters,
            ...
            new Function(c, "transform", _n_transform0, None, Compiled, qt_QBrush_transform_QTransform_QBrush, Return, "qt.QTransform",
                         Parameters, new Param(c, "this", "qt.QBrush"), End),
            // MISSING: QVariant ("QVariant operator"; QBrush this)
            // static functions
            EndArguments);
