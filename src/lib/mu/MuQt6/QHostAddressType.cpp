...
namespace Mu
{
    ...
    bool qt_QHostAddress_isBroadcast_bool_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
    ...
    bool qt_QHostAddress_isEqual_bool_QHostAddress_QHostAddress_int(Mu::Thread& NODE_THREAD, Pointer param_this, Pointer param_other,
                                                                    int param_mode)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
        const QHostAddress arg1 = getqtype<QHostAddressType>(param_other);
        QHostAddress::ConversionMode arg2 = (QHostAddress::ConversionMode)(param_mode);
        return arg0.isEqual(arg1, arg2);
    }

    bool qt_QHostAddress_isGlobal_bool_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
    ...
    bool qt_QHostAddress_isLinkLocal_bool_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
    ...
    bool qt_QHostAddress_isSiteLocal_bool_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
    ...
    bool qt_QHostAddress_isUniqueLocalUnicast_bool_QHostAddress(Mu::Thread& NODE_THREAD, Pointer param_this)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QHostAddress arg0 = getqtype<QHostAddressType>(param_this);
    ...
    {
        NODE_RETURN(qt_QHostAddress_isBroadcast_bool_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_isEqual0, bool)
    {
        NODE_RETURN(qt_QHostAddress_isEqual_bool_QHostAddress_QHostAddress_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer),
                                                                               NODE_ARG(1, Pointer), NODE_ARG(2, int)));
    }

    static NODE_IMPLEMENTATION(_n_isGlobal0, bool)
    {
        NODE_RETURN(qt_QHostAddress_isGlobal_bool_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QHostAddress_isLinkLocal_bool_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    {
        NODE_RETURN(qt_QHostAddress_isSiteLocal_bool_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }

    static NODE_IMPLEMENTATION(_n_isUniqueLocalUnicast0, bool)
    {
        NODE_RETURN(qt_QHostAddress_isUniqueLocalUnicast_bool_QHostAddress(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer)));
    }
    ...
    void QHostAddressType::load()
    {
        ...
        addSymbols(new Alias(c, "ConversionModeFlag", "int"), new Alias(c, "ConversionMode", "int"),
                   new SymbolicConstant(c, "StrictConversion", "int", Value(int(QHostAddress::StrictConversion))),
                   new SymbolicConstant(c, "ConvertV4MappedToIPv4", "int", Value(int(QHostAddress::ConvertV4MappedToIPv4))),
                   new SymbolicConstant(c, "ConvertV4CompatToIPv4", "int", Value(int(QHostAddress::ConvertV4CompatToIPv4))),
                   new SymbolicConstant(c, "ConvertLocalHost", "int", Value(int(QHostAddress::ConvertLocalHost))),
                   new SymbolicConstant(c, "ConvertUnspecifiedAddress", "int", Value(int(QHostAddress::ConvertUnspecifiedAddress))),
                   new SymbolicConstant(c, "TolerantConversion", "int", Value(int(QHostAddress::TolerantConversion))),
                   new Alias(c, "SpecialAddress", "int"), new SymbolicConstant(c, "Null", "int", Value(int(QHostAddress::Null))),
        ...
        addSymbols(
            ...
            // sockaddr)
            new Function(c, "QHostAddress", _n_QHostAddress5, None, Compiled, qt_QHostAddress_QHostAddress_QHostAddress_QHostAddress_string,
            ...
            new Function(c, "isBroadcast", _n_isBroadcast0, None, Compiled, qt_QHostAddress_isBroadcast_bool_QHostAddress, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QHostAddress"), End),
            new Function(c, "isEqual", _n_isEqual0, None, Compiled, qt_QHostAddress_isEqual_bool_QHostAddress_QHostAddress_int, Return,
                         "bool", Parameters, new Param(c, "this", "qt.QHostAddress"), new Param(c, "other", "qt.QHostAddress"),
                         new Param(c, "mode", "int", Value((int)QHostAddress::TolerantConversion)), End),
            new Function(c, "isGlobal", _n_isGlobal0, None, Compiled, qt_QHostAddress_isGlobal_bool_QHostAddress, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QHostAddress"), End),
            ...
            new Function(c, "isLinkLocal", _n_isLinkLocal0, None, Compiled, qt_QHostAddress_isLinkLocal_bool_QHostAddress, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QHostAddress"), End),
            ...
            new Function(c, "isNull", _n_isNull0, None, Compiled, qt_QHostAddress_isNull_bool_QHostAddress, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QHostAddress"), End),
            new Function(c, "isSiteLocal", _n_isSiteLocal0, None, Compiled, qt_QHostAddress_isSiteLocal_bool_QHostAddress, Return, "bool",
                         Parameters, new Param(c, "this", "qt.QHostAddress"), End),
            new Function(c, "isUniqueLocalUnicast", _n_isUniqueLocalUnicast0, None, Compiled,
                         qt_QHostAddress_isUniqueLocalUnicast_bool_QHostAddress, Return, "bool", Parameters,
                         new Param(c, "this", "qt.QHostAddress"), End),
            ...
            new Function(c, "setAddress", _n_setAddress4, None, Compiled, qt_QHostAddress_setAddress_bool_QHostAddress_string, Return,
