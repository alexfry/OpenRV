...
namespace Mu
{
                                                         ...
                                                         int param_options)
    {
        ...
        QUrl::UserInputResolutionOptions arg2 = (QUrl::UserInputResolutionOptions)(param_options);
    ...
    void QUrlType::load()
    {
        ...
        addSymbols(new Alias(c, "AceProcessingOption", "int"), new Alias(c, "AceProcessingOptions", "int"),
                   new SymbolicConstant(c, "IgnoreIDNWhitelist", "int", Value(int(QUrl::IgnoreIDNWhitelist))),
                   new SymbolicConstant(c, "AceTransitionalProcessing", "int", Value(int(QUrl::AceTransitionalProcessing))),
                   new Alias(c, "ComponentFormattingOption", "int"), new Alias(c, "ComponentFormattingOptions", "int"),
        ...
        addSymbols(
            ...
            new Function(c, "QUrl", _n_QUrl1, None, Compiled, qt_QUrl_QUrl_QUrl_QUrl_string_int, Return, "qt.QUrl", Parameters,
            ...
            new Function(c, "fromUserInput", _n_fromUserInput0, None, Compiled, qt_QUrl_fromUserInput_QUrl_string_string_int, Return,
