...
namespace Mu
{
    ...
    Pointer qt_QModelIndex_siblingAtColumn_QModelIndex_QModelIndex_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_column)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QModelIndex arg0 = getqtype<QModelIndexType>(param_this);
        int arg1 = (int)(param_column);
        return makeqtype<QModelIndexType>(c, arg0.siblingAtColumn(arg1), "qt.QModelIndex");
    }

    Pointer qt_QModelIndex_siblingAtRow_QModelIndex_QModelIndex_int(Mu::Thread& NODE_THREAD, Pointer param_this, int param_row)
    {
        MuLangContext* c = static_cast<MuLangContext*>(NODE_THREAD.context());
        QModelIndex arg0 = getqtype<QModelIndexType>(param_this);
        int arg1 = (int)(param_row);
        return makeqtype<QModelIndexType>(c, arg0.siblingAtRow(arg1), "qt.QModelIndex");
    }
    ...
    {
        NODE_RETURN(qt_QModelIndex_siblingAtColumn_QModelIndex_QModelIndex_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
    }

    static NODE_IMPLEMENTATION(_n_siblingAtRow0, Pointer)
    {
        NODE_RETURN(qt_QModelIndex_siblingAtRow_QModelIndex_QModelIndex_int(NODE_THREAD, NONNIL_NODE_ARG(0, Pointer), NODE_ARG(1, int)));
    }
    ...
    void QModelIndexType::load()
    {
        ...
        addSymbols(
            ...
            new Function(c, "siblingAtColumn", _n_siblingAtColumn0, None, Compiled,
                         qt_QModelIndex_siblingAtColumn_QModelIndex_QModelIndex_int, Return, "qt.QModelIndex", Parameters,
                         new Param(c, "this", "qt.QModelIndex"), new Param(c, "column", "int"), End),
            new Function(c, "siblingAtRow", _n_siblingAtRow0, None, Compiled, qt_QModelIndex_siblingAtRow_QModelIndex_QModelIndex_int,
                         Return, "qt.QModelIndex", Parameters, new Param(c, "this", "qt.QModelIndex"), new Param(c, "row", "int"), End),
            // static functions
            EndArguments);
